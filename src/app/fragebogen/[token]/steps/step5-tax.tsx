...
export function Step5Tax({ data, onNext, onBack, saving }: StepProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-foreground">
          Steuerklasse <span className="text-destructive">*</span>
        </label>
        <select
          {...register("taxClass")}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-2">
          <label className="text-sm font-medium text-foreground">
            Jaehrlicher Freibetrag (optional)
          </label>
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-foreground">
          Religionszugehoerigkeit (fuer Kirchensteuer){" "}
          <span className="text-destructive">*</span>
        </label>
        <select
          {...register("religion")}
