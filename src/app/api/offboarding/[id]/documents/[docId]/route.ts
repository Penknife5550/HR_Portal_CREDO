...
export async function GET(
  ...
  try {
    ...
    // (@/lib/file-upload) - dieselbe Funktion wie beim BEM-Download, beim
    // Download erzeugter Brief-Dokumente und in der Schwesterroute
    ...
    // mal bricht der Download ab. Ein Offboarding-Dokument heisst im Portal
    // nun einmal "Kuendigung Mueller.pdf" mit echtem "ue"; der Fall war also
    // der Normalfall und nicht die Ausnahme.
    //
    // Der ausgelieferte Name aendert sich dadurch sichtbar: Umlaute UND
    // Leerzeichen werden zu Unterstrichen. Das ist gewollt - ein lesbarer,
    // aber kaputt uebertragener Name ist schlechter als ein sperriger, der
    // ankommt. Der Name in der Oberflaeche bleibt unberuehrt: Er kommt aus
